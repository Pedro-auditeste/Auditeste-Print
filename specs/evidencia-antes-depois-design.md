...
- A ponte descreve cada par de forma assíncrona com a NVIDIA; uma falha nunca remove os prints.
...
5. O registro e o HTML exportado preservam o agrupamento e os metadados.
