/* Trace: varredura dinamica (DAST). Ataca o servico em execucao.
 *
 *   node dast.js
 *
 * Enquanto teste-trace.js pergunta "o caminho certo funciona?", este
...
const dir = fs.mkdtempSync(path.join(os.tmpdir(), 'trace-dast-'));
process.env.TRACE_BANCO = path.join(dir, 'm.db');
...
(async () => {
  console.log('\nvarredura dinamica - trace em 127.0.0.1:' + PORTA + '\n');
